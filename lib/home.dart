...
class _MyHomePageState extends State<MyHomePage> {
  static const double _defaultCardPlaceholderHeight = 220;
  static const double _galleryPlaceholderHeight = 320;
  ...
  Widget build(BuildContext context) {
    ...
    Widget animatedCard({required Widget child, required int index}) {
      ...
      if (disableAnimations || index <= 1) {
        return Center(child: cardChild);
      }
        ...
        case 1:
          return animatedCard(
            child: DeferredWidget(
              ...
              placeholder: const CardPlaceholder(
                minHeight: _defaultCardPlaceholderHeight,
              ),
        ...
        case 4:
          return animatedCard(
            child: DeferredWidget(
              ...
              minPlaceholderDuration: Duration.zero,
              placeholder: const CardPlaceholder(
                minHeight: _galleryPlaceholderHeight,
              ),
