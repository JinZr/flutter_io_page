...
class _MyIntroductionState extends State<MyIntroduction> {
  late final TapGestureRecognizer _liuRecognizer = TapGestureRecognizer()
    ..onTap = () => launchURL('https://www1.se.cuhk.edu.hk/~xyliu/');
  late final TapGestureRecognizer _zhangRecognizer = TapGestureRecognizer()
    ..onTap = () => launchURL('https://mi.eng.cam.ac.uk/~cz277/');

  @override
  void dispose() {
    _liuRecognizer.dispose();
    _zhangRecognizer.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bodyStyle =
        (widget.isCompact ? textTheme.bodyLarge : textTheme.bodyLarge) ??
