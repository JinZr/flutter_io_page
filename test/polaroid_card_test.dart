...
void main() {
  testWidgets('uses same description typography in compact and regular layouts', (
    ...
    final expectedCompactFontSize =
        (compactTextTheme.bodyLarge ?? compactTextTheme.bodyMedium!).fontSize;
  ...
  testWidgets('keeps weighted carousel on narrow widths', (
    ...
    final carouselSize = tester.getSize(find.byType(CarouselView));
    expect(carouselSize.height, inInclusiveRange(240, 320));
