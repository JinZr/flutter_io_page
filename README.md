...
The build script creates a WebAssembly-capable release build with icon
tree-shaking. Source maps are now opt-in via
`ENABLE_SOURCE_MAPS=1 ./build.sh`. Release output is written to the default
